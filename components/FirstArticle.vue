  ...
  <div class="my-8 px-4 md:h-[210px] lg:mt-10 lg:mb-11 lg:px-7">
    <div class="relative rounded-[4px] md:bg-black">
      ...
      <div class="md:h-[210px] md:rounded-[4px]">
        ...
        <div
          class="before:top top-0 right-0 h-full rounded-tl-[4px] border-t-[3px] border-l-[3px] border-black bg-cover pt-5 before:absolute before:left-2.5 before:top-2.5 before:block before:h-[calc(100%_-_10px)] before:w-[calc(100%_-_10px)] before:rounded-tl-[4px] before:border-t-[3px] before:border-l-[3px] before:border-black md:absolute md:w-full md:overflow-hidden md:rounded-[4px] md:pt-0 before:md:hidden"
        >
          <div
          ...
          >
            <h3
              ...
              class="w-full text-2xl font-bold text-black underline md:w-2/3 md:text-4xl md:text-white md:no-underline"
            />
            <nuxt-link
              :to="{
